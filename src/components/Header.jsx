...
export function Header({ page, onNav, gameTab, onGameTab, lang, onLangSet, user, authLoading, onLoginClick, onSignOut, onUpdateNickname, earnedIds, onEquipTitle, dex, onUpdateProfilePokemon, onInstagramClick }) {
  const isEn = lang === 'en';
    ...
    <header>
      <div className="header-top">
        ...
        <div className="nav">
          ...
          <div className="nav-divider" />
          <a className="nav-social-btn" href="https://www.instagram.com/poke_clue_/" target="_blank" rel="noopener noreferrer" title="Instagram" onClick={onInstagramClick}>
