...
export const GENERAL_TITLES = [
  ...
  },
  {
    ...
    en: 'Stardust',
    emoji: '✨',
    desc_ko: '모든 속성이 일치하지만 정답이 아닌 추측을 30회 이상 누적',
    desc_en: 'Accumulated 30+ guesses matching all attributes but not the answer',
    rarity: 'legendary',
  ...
  },
  {
    ...
    en: 'Gym',
    emoji: '🏛️',
    desc_ko: '챌린지 모드 30회 클리어',
    desc_en: 'Clear Challenge mode 30 times',
    rarity: 'common',
  ...
  },
  {
    id: 'challenge_50',
    ko: '섬 순례',
    en: 'Island Pilgrimage',
    emoji: '🏝️',
    desc_ko: '챌린지 모드 50회 클리어',
    desc_en: 'Clear Challenge mode 50 times',
    rarity: 'rare',
    progressGroup: 'challenge_clears',
    threshold: 50,
  },
  {
    ...
    en: 'Champion Road',
    emoji: '🛤️',
    desc_ko: '챌린지 모드 100회 클리어',
    desc_en: 'Clear Challenge mode 100 times',
    rarity: 'epic',
    progressGroup: 'challenge_clears',
    threshold: 100,
  },
  {
    ...
    en: 'Hall of Fame',
    emoji: '🏅',
    desc_ko: '챌린지 모드 300회 클리어',
    desc_en: 'Clear Challenge mode 300 times',
    rarity: 'legendary',
    progressGroup: 'challenge_clears',
    threshold: 300,
  },
